...
/**
 * Оценка армий — раздел 5 «Рейтинга существ Olden Era». Это не механика
 * игры, а договорённость о том, как читать результат сравнения.
 */
export const ARMY_RULES = {
  /**
   * Разницу мощности в пределах этой доли считаем ничьей. Документ говорит
   * «1–3%» — берём верхнюю границу: победителя называем, только когда
   * отрыв уверенный. Граница включается: ровно 3% — ещё ничья.
   */
  tieThreshold: 0.03,
} as const
