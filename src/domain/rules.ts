...
export const ARMY_RULES = {
  ...
  minArmies: 1,
  /** армии нумеруются римскими цифрами — их список в components/roman.ts не короче */
  maxArmies: 9,
  /**
...
export const F = {
  ...
  /** трёхзначные — с запасом на баффы; с бонусом героя в поле видна сумма, до 1098 */
  attack: { min: 0, max: 999, step: 1 },
  defense: { min: 0, max: 999, step: 1 },
